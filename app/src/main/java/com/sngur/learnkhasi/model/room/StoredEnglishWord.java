...
public class StoredEnglishWord {
    @PrimaryKey @NonNull
    ...
    @Ignore
    public StoredEnglishWord() {
    }

    public StoredEnglishWord(@NonNull String wordId, String word, String userId, String audioUrl, int reported, Long timestamp, int noOfVotes, String userName, String wordType, String englishMeaning, String khasiMeaning, boolean translatedToKhasi, boolean translatedToEnglish, boolean translatedToHindi, boolean translatedToGaro) {
        this.wordId = wordId;
        this.word = word;
        this.userId = userId;
